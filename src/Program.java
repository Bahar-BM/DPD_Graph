...
import graph.MethodChecking;
import graph.Node;
import javafx.util.Pair;
import load.GraphCreator;
import result.resultMaker.ResultViewer;
import result.resultStructureModel.*;
...
public class Program {
    static String sourceJsonPath = "ClassDiagram.json";
...
//            System.out.println("third : dest result path");
//            return;
//        }
...
//                System.out.println();
                for (int j = 0; j < nodeMaps.size(); j++) {
                    ...
                    MethodChecking methodChecking = new MethodChecking(maps, patternGraphCreator[k].getName(), "materials/generatedCode.jar", "targetCode");
